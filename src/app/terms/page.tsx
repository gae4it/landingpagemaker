        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 rounded-lg border-2 border-yellow-700/50 bg-yellow-950/30 p-6">
            <div className="flex gap-4">
              ...
              <div>
                <h2 className="text-yellow-300 text-xl font-bold mb-2">
                  📚 Educational Project Disclaimer
                </h2>
                <p className="text-yellow-200/90 text-base leading-relaxed">
                  LandingPageMaker is an <strong>educational, non-commercial
                  project</strong> designed to help developers and designers
                  learn how to build landing pages using Tailwind CSS. This is
                  NOT a commercial service, and these terms reflect that nature.
                  By using this service, you understand and agree that this is
                  an educational resource shared by the community.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using LandingPageMaker, you accept and agree
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                This service is provided "as-is" for educational purposes only.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-muted/30 rounded-lg p-6 space-y-4 my-4">
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-2 ml-6 list-disc">
                    ...
                    <li>Copy and modify components for your personal projects</li>
                    <li>Use components in commercial projects</li>
                    <li>Learn from the patterns and best practices demonstrated</li>
                ...
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-2 ml-6 list-disc">
                    ...
                    <li>Rebrand LandingPageMaker components as your own product</li>
                    <li>Remove copyright notices or attributions</li>
                    <li>Use the site for commercial scraping or harvesting</li>
                    <li>Bypass security measures or attempt unauthorized access</li>
            ...
            <section>
              ...
              <ul className="text-muted-foreground space-y-2 ml-6 list-disc">
                <li>The LandingPageMaker name, logo, and branding are not covered
                  by the MIT License</li>
                ...
                <li>Tailwind CSS is provided under the Tailwind CSS Free License</li>
            ...
            <section>
              ...
              <ul className="text-muted-foreground space-y-2 ml-6 list-disc">
                <li>Code samples may not work in all environments or versions</li>
            ...
            <section>
              ...
              <ul className="text-muted-foreground space-y-2 ml-6 list-disc">
                ...
                <li>Respect the time and resources invested by the maintainers</li>
                <li>Provide constructive feedback and report bugs responsibly</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                LandingPageMaker makes no representations or warranties regarding
                the completeness, accuracy, timeliness, or functionality of the
                code samples, components, or documentation. To the fullest extent
                permitted by law, LandingPageMaker disclaims all warranties,
                express or implied.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                time. Changes will be posted with an updated "Last updated" date.
          ...
          {/* Closing Statement */}
          <div className="mt-12 rounded-lg bg-muted/30 p-6 border border-border">
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              of the service immediately. Thank you for being part of our
