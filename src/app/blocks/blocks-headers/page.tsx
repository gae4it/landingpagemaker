...
import { Menu, Search, LogIn, Sun, Moon, ChevronDown } from "lucide-react";
...
export default function BlocksHeadersPage() {
  ...
  const stickyNavReactSnippet = `<header className="sticky top-0 z-50 border-b border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="flex h-16 items-center justify-between">
      <div className="text-2xl font-bold text-blue-600">Brand</div>
      <nav className="hidden gap-8 md:flex">
        <a href="#" className="font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Home</a>
        <a href="#" className="font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Features</a>
        <a href="#" className="font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Pricing</a>
        <a href="#" className="font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Docs</a>
      </nav>
  ...
  const megaMenuReactSnippet = `<header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="flex h-16 items-center justify-between">
      <div className="text-2xl font-bold text-blue-600">Brand</div>
      <nav className="hidden gap-6 lg:flex">
        <div className="group relative">
          ...
          <div className="invisible absolute left-0 mt-0 w-48 rounded-lg bg-white opacity-0 shadow-lg transition-all group-hover:visible group-hover:opacity-100 dark:bg-slate-900">
            <a href="#" className="block px-4 py-2 text-slate-600 first:rounded-t-lg hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800">Product 1</a>
            <a href="#" className="block px-4 py-2 text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800">Product 2</a>
            <a href="#" className="block px-4 py-2 text-slate-600 last:rounded-b-lg hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800">Product 3</a>
          </div>
        </div>
        <a href="#" className="py-8 font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Solutions</a>
        <a href="#" className="py-8 font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Pricing</a>
        <a href="#" className="py-8 font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Docs</a>
      </nav>
  ...
  const darkToggleHeaderReactSnippet = `<header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="flex h-16 items-center justify-between">
      <div className="text-2xl font-bold text-blue-600">Brand</div>
      <nav className="hidden gap-8 md:flex">
        <a href="#" className="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Features</a>
        <a href="#" className="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Pricing</a>
        <a href="#" className="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">About</a>
      </nav>
      <div className="flex items-center gap-4">
        <button className="rounded-lg p-2 text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800" aria-label="Toggle dark mode">
  ...
  const searchBarHeaderReactSnippet = `<header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="flex h-16 items-center justify-between">
      <div className="text-2xl font-bold text-blue-600">Brand</div>
      <div className="mx-8 hidden flex-1 md:flex">
        <div className="relative w-full max-w-md">
          <Search size={20} className="absolute top-1/2 left-3 -translate-y-1/2 transform text-slate-400" />
          <input
            type="text"
            placeholder="Search..."
      ...
      <nav className="hidden gap-8 md:flex">
        ...
        <a href="#" className="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Blog</a>
      </nav>
    </div>
  </div>
</header>`;

  const authButtonsHeaderReactSnippet = `<header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="flex h-16 items-center justify-between">
      <div className="text-2xl font-bold text-blue-600">Brand</div>
      <nav className="hidden gap-8 md:flex">
  ...
  const breadcrumbHeaderReactSnippet = `<header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="mb-4 flex h-16 items-center justify-between">
      <div className="text-2xl font-bold text-blue-600">Brand</div>
      <nav className="hidden gap-8 md:flex">
        <a href="#" className="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Home</a>
        <a href="#" className="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Products</a>
      </nav>
    </div>
    <nav className="pb-4 text-sm text-slate-600 dark:text-slate-400">
      <ol className="flex gap-2">
        ...
        <li>/</li>
        <li><a href="#" className="hover:text-slate-900 dark:hover:text-white">Products</a></li>
        <li>/</li>
  ...
  const announcementBarHeaderReactSnippet = `<>
  <header className="bg-blue-600 py-3 text-white">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
  ...
  const transparentOverHeroReactSnippet = `<div className="relative h-96 overflow-hidden rounded-lg bg-linear-to-r from-blue-600 to-purple-600">
  <header className="absolute top-0 right-0 left-0 z-10">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex h-16 items-center justify-between">
        <div className="text-2xl font-bold text-white">Brand</div>
        <nav className="hidden gap-8 md:flex">
          <a href="#" className="font-medium text-white hover:text-blue-100">Home</a>
          <a href="#" className="font-medium text-white hover:text-blue-100">Features</a>
          <a href="#" className="font-medium text-white hover:text-blue-100">Pricing</a>
        </nav>
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center text-white">
      ...
      <p className="text-xl text-blue-100">Header overlaid on hero section</p>
    </div>
  </div>
</div>`;
          ...
          <div className="relative">
            <SectionDivider title="Sticky Navigation Bar">
              <CopySnippetButtons
                ...
                reactSnippet={stickyNavReactSnippet}
              />
            </SectionDivider>
            <header
              ref={sectionRef1}
          ...
          <div className="relative">
            <SectionDivider title="Mega Menu">
              <CopySnippetButtons
                ...
                reactSnippet={megaMenuReactSnippet}
              />
            </SectionDivider>
            <header
              ref={sectionRef2}
          ...
          <div className="relative">
            <SectionDivider title="Dark/Light Toggle">
              <CopySnippetButtons
                ...
                reactSnippet={darkToggleHeaderReactSnippet}
              />
            </SectionDivider>
            <header
              ref={sectionRef3}
          ...
          <div className="relative">
            <SectionDivider title="Search Bar">
              <CopySnippetButtons
                ...
                reactSnippet={searchBarHeaderReactSnippet}
              />
            </SectionDivider>
            <header
              ref={sectionRef4}
          ...
          <div className="relative">
            <SectionDivider title="Auth Buttons">
              <CopySnippetButtons
                ...
                reactSnippet={authButtonsHeaderReactSnippet}
              />
            </SectionDivider>
            <header
              ref={sectionRef5}
          ...
          <div className="relative">
            <SectionDivider title="Breadcrumb Navigation">
              <CopySnippetButtons
                ...
                reactSnippet={breadcrumbHeaderReactSnippet}
              />
            </SectionDivider>
            <header
              ref={sectionRef6}
          ...
          <div className="relative">
            <SectionDivider title="Announcement Bar">
              <CopySnippetButtons
                ...
                reactSnippet={announcementBarHeaderReactSnippet}
              />
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Transparent Over Hero">
              <CopySnippetButtons
                ...
                reactSnippet={transparentOverHeroReactSnippet}
              />
            </SectionDivider>
            <div
              ref={sectionRef8}
