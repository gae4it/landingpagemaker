...
export default function BlocksPricingPage() {
  ...
  const simplePricingReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  ...
  const pricingToggleReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
      {[
        { name: "Professional", price: "$49", features: ["10 Team members", "200GB Storage", "Email Support", "Analytics Dashboard"] },
        { name: "Business", price: "$99", features: ["Unlimited Team members", "1TB Storage", "Priority Support", "Advanced Analytics", "API Access"] },
      ].map((plan, idx) => (
        <div key={idx} className="rounded-lg border border-neutral-200 bg-white p-8 dark:border-neutral-800 dark:bg-neutral-900">
          <h3 className="text-2xl font-bold text-neutral-950 dark:text-neutral-50">{plan.name}</h3>
          <div className="mt-6 flex items-baseline">
            <span className="text-5xl font-bold text-neutral-950 dark:text-neutral-50">{plan.price}</span>
  ...
  const pricingComparisonReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="mx-auto mb-16 max-w-2xl text-center">
      <h2 className="text-3xl font-bold text-neutral-950 sm:text-4xl dark:text-neutral-50">
        Compare plans
      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-neutral-200 dark:border-neutral-800">
            <th className="px-6 py-4 text-left text-sm font-semibold text-neutral-950 dark:text-neutral-50">Features</th>
        ...
        <tbody>
          {[
            ...
            { feature: "Team Members", basic: "1", pro: "10", enterprise: "Unlimited" },
            ...
            <tr key={idx} className="border-b border-neutral-100 dark:border-neutral-900">
              <td className="px-6 py-4 text-sm text-neutral-700 dark:text-neutral-300">{row.feature}</td>
  ...
  const singlePlanReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
    <div className="rounded-lg border border-neutral-200 bg-white p-12 text-center dark:border-neutral-800 dark:bg-neutral-900">
      <h2 className="text-3xl font-bold text-neutral-950 dark:text-neutral-50">One simple price</h2>
      <div className="mt-8 flex items-baseline justify-center">
        <span className="text-6xl font-bold text-neutral-950 dark:text-neutral-50">$39</span>
        <span className="ml-2 text-xl text-neutral-600 dark:text-neutral-400">/month</span>
      </div>
      <p className="mt-4 text-lg text-neutral-600 dark:text-neutral-400">
        Everything you need to get started
      </p>
      <ul className="mt-12 space-y-4 text-left">
        {["Unlimited projects", "100GB storage", "Priority support", "Advanced analytics", "Team collaboration"].map((feature) => (
  ...
  const pricingHighlightsReactSnippet = `<section className="relative bg-linear-to-b from-neutral-50 to-white py-16 sm:py-24 dark:from-neutral-950 dark:to-neutral-900">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      {[
        { name: "Starter", price: "$19", highlight: "Perfect for individuals", featured: false },
        { name: "Team", price: "$49", highlight: "Best for small teams", featured: true },
        { name: "Enterprise", price: "Custom", highlight: "For large organizations", featured: false },
      ].map((plan, idx) => (
        <div
          key={idx}
        ...
        >
          <div className="text-center">
            <h3 className={\`text-2xl font-bold \${plan.featured ? "text-white dark:text-neutral-900" : "text-neutral-950 dark:text-neutral-50"}\`}>
              {plan.name}
            </h3>
            <p className={\`mt-2 text-sm \${plan.featured ? "text-neutral-200 dark:text-neutral-700" : "text-neutral-600 dark:text-neutral-400"}\`}>
              {plan.highlight}
            </p>
            <div className="mt-6 flex items-baseline justify-center">
              <span className={\`text-5xl font-bold \${plan.featured ? "text-white dark:text-neutral-900" : "text-neutral-950 dark:text-neutral-50"}\`}>
                {plan.price}
              </span>
              {plan.price !== "Custom" && (
                <span className={\`ml-2 \${plan.featured ? "text-neutral-300 dark:text-neutral-600" : "text-neutral-600 dark:text-neutral-400"}\`}>
                  /mo
                </span>
              )}
            </div>
            <button className={\`mt-8 w-full rounded-lg px-4 py-2.5 font-semibold \${plan.featured ? "bg-white text-neutral-900 hover:bg-neutral-100 dark:bg-neutral-900 dark:text-neutral-50 dark:hover:bg-neutral-800" : "bg-neutral-900 text-white hover:bg-neutral-800 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-200"}\`}>
              Choose plan
            </button>
          </div>
        </div>
  ...
  const minimalPricingReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
      {[
        ...
        >
          <h3 className="text-lg font-semibold text-neutral-950 dark:text-neutral-50">{plan.name}</h3>
          <div className="mt-4 flex items-baseline">
            <span className="text-4xl font-bold text-neutral-950 dark:text-neutral-50">{plan.price}</span>
            <span className="ml-1 text-neutral-600 dark:text-neutral-400">/mo</span>
          </div>
          ...
          <div className="relative">
            <SectionDivider title="Simple 3-Tier Pricing">
              <CopySnippetButtons
                ...
                reactSnippet={simplePricingReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef1}
          ...
          <div className="relative">
            <SectionDivider title="Pricing with Monthly/Yearly Toggle">
              <CopySnippetButtons
                ...
                reactSnippet={pricingToggleReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef2}
          ...
          <div className="relative">
            <SectionDivider title="Pricing Comparison Table">
              <CopySnippetButtons
                ...
                reactSnippet={pricingComparisonReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef3}
          ...
          <div className="relative">
            <SectionDivider title="Single Centered Plan">
              <CopySnippetButtons
                ...
                reactSnippet={singlePlanReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef4}
          ...
          <div className="relative">
            <SectionDivider title="Pricing with Highlights">
              <CopySnippetButtons
                ...
                reactSnippet={pricingHighlightsReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef5}
          ...
          <div className="relative">
            <SectionDivider title="Minimal Pricing Cards">
              <CopySnippetButtons
                ...
                reactSnippet={minimalPricingReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef6}
