        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <SectionDivider title="Call-To-Action Block 4">
              <Button variant="ghost" size="icon" onClick={() => handleCopy(sectionRef4)} className="absolute right-2 top-2" aria-label="Copy section HTML">
                <Copy size={18} />
              </Button>
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Call-To-Action Block 5">
              <Button variant="ghost" size="icon" onClick={() => handleCopy(sectionRef5)} className="absolute right-2 top-2" aria-label="Copy section HTML">
                <Copy size={18} />
              </Button>
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Call-To-Action Block 6">
              <Button variant="ghost" size="icon" onClick={() => handleCopy(sectionRef6)} className="absolute right-2 top-2" aria-label="Copy section HTML">
                <Copy size={18} />
              </Button>
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Call-To-Action Block 7">
              <Button variant="ghost" size="icon" onClick={() => handleCopy(sectionRef7)} className="absolute right-2 top-2" aria-label="Copy section HTML">
                <Copy size={18} />
              </Button>
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Call-To-Action Block 8">
              <Button variant="ghost" size="icon" onClick={() => handleCopy(sectionRef8)} className="absolute right-2 top-2" aria-label="Copy section HTML">
                <Copy size={18} />
              </Button>
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Call-To-Action Block 9">
              <Button variant="ghost" size="icon" onClick={() => handleCopy(sectionRef9)} className="absolute right-2 top-2" aria-label="Copy section HTML">
                <Copy size={18} />
              </Button>
            </SectionDivider>
