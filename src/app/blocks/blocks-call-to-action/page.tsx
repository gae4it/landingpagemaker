...
import { ArrowRight, Mail, Zap, Shield, Users } from "lucide-react";
...
export default function BlocksCallToActionPage() {
  ...
  const fullWidthCtaReactSnippet = `<section className="relative bg-neutral-900 py-12 dark:bg-neutral-950">
  ...
  const ctaCardsGridReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
      {[
        { icon: Zap, title: "Fast Setup", desc: "Get started in minutes" },
        { icon: Shield, title: "Secure", desc: "Enterprise-grade security" },
        { icon: Users, title: "Team Ready", desc: "Built for collaboration" },
      ].map((item, idx) => (
        <div
          key={idx}
        ...
        >
          ...
          <p className="mb-4 text-neutral-600 dark:text-neutral-400">{item.desc}</p>
  ...
  const newsletterCtaReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-2xl px-4 text-center sm:px-6 lg:px-8">
    ...
    <form className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
      <input
        ...
        className="max-w-md flex-1 rounded-lg border border-neutral-300 bg-white px-4 py-3 text-neutral-900 placeholder:text-neutral-500 focus:ring-2 focus:ring-neutral-900 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-50"
      />
      <button
        type="submit"
  ...
  const splitCtaReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-900">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
      <div>
        ...
        <p className="mt-4 text-lg text-neutral-600 dark:text-neutral-400">
          No credit card required. Cancel anytime. Get full access for 14 days.
        </p>
        <ul className="mt-8 space-y-4">
          {["Unlimited projects", "24/7 support", "Advanced analytics"].map((feature) => (
      ...
      <div className="rounded-lg border border-neutral-200 bg-white p-8 dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input
              type="email"
              className="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2.5 text-neutral-900 focus:ring-2 focus:ring-neutral-900 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-50"
  ...
  const gradientCtaReactSnippet = `<section className="relative overflow-hidden bg-linear-to-r from-neutral-900 via-neutral-800 to-neutral-900 py-20 sm:py-28 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
  <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
    <h2 className="text-4xl font-bold text-white sm:text-5xl">
      Transform your workflow today
    </h2>
    <p className="mt-6 text-lg text-neutral-300">
      Join 10,000+ teams already building better products with our platform.
    </p>
  ...
  const minimalCtaReactSnippet = `<section className="relative py-20 sm:py-28">
          ...
          <div className="relative">
            <SectionDivider title="Full Width CTA Banner">
              <CopySnippetButtons
                ...
                reactSnippet={fullWidthCtaReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef1}
          ...
          <div className="relative">
            <SectionDivider title="CTA Cards Grid">
              <CopySnippetButtons
                ...
                reactSnippet={ctaCardsGridReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef2}
          ...
          <div className="relative">
            <SectionDivider title="Newsletter CTA">
              <CopySnippetButtons
                ...
                reactSnippet={newsletterCtaReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef3}
          ...
          <div className="relative">
            <SectionDivider title="Split CTA Section">
              <CopySnippetButtons
                ...
                reactSnippet={splitCtaReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef4}
          ...
          <div className="relative">
            <SectionDivider title="Gradient CTA">
              <CopySnippetButtons
                ...
                reactSnippet={gradientCtaReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef5}
          ...
          <div className="relative">
            <SectionDivider title="Minimal CTA">
              <CopySnippetButtons
                ...
                reactSnippet={minimalCtaReactSnippet}
              />
            </SectionDivider>
