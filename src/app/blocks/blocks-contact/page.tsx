              ...
              <div className="relative container mx-auto px-4">
                <div className="-mx-4 flex flex-wrap items-center">
                  <div className="w-full p-4 lg:w-5/12">
                    <h2 className="mb-6 text-2xl leading-tight font-bold text-gray-800 uppercase">
                      Get In Touch
                    </h2>
                    <p className="mb-10">
                      ...
                      <ul className="mb-10 space-y-6">
                        <li className="flex">
                          ...
                          <svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="mr-6 h-6 w-6 text-blue-600"
                          >
                  ...
                  <div className="ml-auto w-full p-4 lg:w-6/12">
                    <div className="bg-white p-10 shadow-xl sm:p-16">
                      ...
                      <form>
                        <div className="mb-6">
                          <input
                            className="w-full appearance-none border-2 border-blue-600 px-5 py-3 outline-none focus:shadow-lg"
                        ...
                        <button
                          type="submit"
                          className="inline-block w-full bg-blue-600 p-3 text-center font-medium text-white uppercase hover:bg-blue-700"
                        >
                          Submit
                        </button>
                      </form>
