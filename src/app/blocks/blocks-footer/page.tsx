      ...
      <main className="bg-background min-h-screen py-16">
        <div className="mx-auto max-w-7xl space-y-16 px-4 sm:px-6 lg:px-8">
              ...
              <div className="container mx-auto px-4 relative">
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full p-4 xl:mr-auto xl:w-4/12">
                    <a href="#" className="font-medium hover:text-blue-800 inline-block mb-6 mr-auto text-3xl text-blue-600 uppercase">
                      Company
                    </a>
                    ...
                    <div className="mb-6">
                      <a href="#" className="hover:text-blue-600">+1 234 567-890</a>
                      <br />
          ...
          <div className="relative mt-12">
            ...
            <section ref={sectionRef2} className="bg-gray-900 font-light pt-12 text-gray-300">
              <div className="container mx-auto px-4 relative">
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full p-4 xl:mr-auto xl:w-4/12">
                    <a href="#" className="font-medium hover:text-blue-800 inline-block mb-6 mr-auto text-3xl text-white uppercase">
                      Company
                    </a>
                    <p className="mb-4 text-sm">
                      Duis pharetra venenatis felis, ut tincidunt ipsum consequat nec. Fusce et porttitor libero, eu aliquam nisi. Nam finibus ullamcorper semper.
                  ...
                  <div className="w-full p-4 xl:w-2/12 sm:w-4/12">
                    <h2 className="font-bold mb-8 text-lg uppercase">About</h2>
                    <ul>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Get Quote</a></li>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Enterprise Plan</a></li>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Become an Affiliate</a></li>
                  ...
                  <div className="w-full p-4 xl:w-2/12 sm:w-4/12">
                    <h2 className="font-bold mb-8 text-lg uppercase">Services</h2>
                    <ul>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Web Design</a></li>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Web Development</a></li>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">WordPress</a></li>
                  ...
                  <div className="w-full p-4 xl:w-2/12 sm:w-4/12">
                    <h2 className="font-bold mb-8 text-lg uppercase">Other</h2>
                    <ul>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Business Stories</a></li>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Learning</a></li>
                      <li className="mb-4"><a href="#" className="hover:text-blue-600">Licence</a></li>
          ...
          <div className="relative mt-12">
            ...
            <section ref={sectionRef3} className="bg-gray-50 font-light pt-12 text-gray-500">
              <div className="container mx-auto px-4 relative">
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full p-4 xl:w-4/12">
                    <a href="#" className="font-semibold hover:text-blue-800 inline-block mb-6 mr-auto text-3xl text-blue-600 uppercase">
                      Company
                    </a>
                    <p className="mb-4">
                      Duis pharetra venenatis felis, ut tincidunt ipsum consequat nec. Fusce et porttitor libero, eu aliquam nisi. Nam finibus ullamcorper semper.
                  ...
                  <div className="p-4 w-full md:w-6/12 xl:w-4/12">
                    <h2 className="font-bold mb-8 text-blue-600 text-lg uppercase">Subscribe</h2>
                    ...
                    <form>
                      <div className="bg-white border-2 border-gray-400 flex items-center mb-6 overflow-hidden p-1">
                        <input className="appearance-none border-blue-600 flex-1 font-light outline-none p-2 text-gray-600 w-full" placeholder="Enter email..." type="email" />
                        <button type="submit" className="bg-blue-600 font-medium hover:bg-blue-700 inline-block px-6 py-2 text-center text-white uppercase" aria-label="submit">
                          <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 inline-block w-4">
                            <path d="M1.946 9.315c-.522-.174-.527-.455.01-.634l19.087-6.362c.529-.176.832.12.684.638l-5.454 19.086c-.15.529-.455.547-.679.045L12 14l6-8-8 6-8.054-2.685z" />
                          </svg>
                        </button>
                      </div>
                    </form>
                    <h2 className="font-bold mb-4 text-blue-600 text-lg uppercase">Get Social</h2>
                    <div className="flex-wrap inline-flex space-x-3">
                      <a href="#" className="hover:text-blue-600" aria-label="facebook">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                          <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z" />
                ...
                <div className="py-4 text-sm">
                  ...
                  <div className="flex flex-wrap -mx-4 items-center">
                    ...
                    <div className="px-4 py-2 w-full sm:w-auto">
                      <a href="#" className="hover:text-blue-600">Privacy Policy</a> | <a href="#" className="hover:text-blue-600">Terms of Use</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="relative mt-12">
            ...
            <section ref={sectionRef4} className="bg-gray-50 font-light pt-12 text-gray-500">
              <div className="container mx-auto px-4 relative">
                <div className="flex flex-wrap -mx-4">
                  ...
                  <div className="p-4 w-full md:w-1/2 lg:w-4/12">
                    <h2 className="font-bold mb-8 text-blue-600 text-lg uppercase">Latest Posts</h2>
                    <div className="space-y-4">
                      <div className="flex flex-wrap items-center w-full">
                        <div className="w-3/12">
                          <a href="#" className="block hover:opacity-75">
                            <img src="https://images.unsplash.com/photo-1468818438311-4bab781ab9b8?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDI4fHx0cmF2ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" className="w-full" alt="..." width="350" height="240" />
                          </a>
                        </div>
                        <div className="pl-3 w-9/12">
                          <a href="#" className="block hover:text-blue-600 mb-1 text-gray-700">
                            <h3 className="font-semibold leading-tight text-sm">Travelling as a way of self-discovery and progress</h3>
                          </a>
                      ...
                      <div className="flex flex-wrap items-center w-full">
                        <div className="w-3/12">
                          <a href="#" className="block hover:opacity-75">
                            <img src="https://images.unsplash.com/photo-1577327966244-999949c7e884?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDEyfHxidXNpbmVzcyUyMHBob3RvZ3JhcGhlcnxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" className="w-full" alt="..." width="350" height="240" />
                          </a>
                        </div>
                        <div className="pl-3 w-9/12">
                          <a href="#" className="block hover:text-blue-600 mb-1 text-gray-700">
                            <h3 className="font-semibold leading-tight text-sm">Where to grow your business as a photographer: site or social media?</h3>
                          </a>
                          <h4 className="text-xs">10 August 2020</h4>
                        </div>
                      </div>
                      <div className="flex flex-wrap items-center w-full">
                        <div className="w-3/12">
                          <a href="#" className="block hover:opacity-75">
                            <img src="https://images.unsplash.com/photo-1522542550221-31fd19575a2d?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDE0MHx8Y29sb3JzJTIwd2Vic2l0ZXxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" className="w-full" alt="..." width="350" height="240" />
                          </a>
                        </div>
                        <div className="pl-3 w-9/12">
                          <a href="#" className="block hover:text-blue-600 mb-1 text-gray-700">
                            <h3 className="font-semibold leading-tight text-sm">How to choose the right colors when creating a website?</h3>
                          </a>
                          <h4 className="text-xs">10 August 2020</h4>
                        </div>
                      </div>
                  ...
                  <div className="p-4 w-full md:w-1/2 lg:w-4/12">
                    ...
                    <p className="mb-4">Subscribe to our newsletter and get exclusive updates directly in your inbox.</p>
                    <form>
                      <div className="bg-white border-2 border-gray-400 flex items-center mb-6 overflow-hidden p-1 rounded-full">
                        <input className="appearance-none border-blue-600 flex-1 font-light outline-none p-2 text-gray-600 w-full" placeholder="Enter email..." type="email" />
                        <button type="submit" className="bg-blue-600 font-medium hover:bg-blue-700 inline-block px-6 py-2 rounded-full text-center text-white uppercase" aria-label="submit">
                          <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 inline-block w-4">
                            <path d="M1.946 9.315c-.522-.174-.527-.455.01-.634l19.087-6.362c.529-.176.832.12.684.638l-5.454 19.086c-.15.529-.455.547-.679.045L12 14l6-8-8 6-8.054-2.685z" />
                          </svg>
                        </button>
