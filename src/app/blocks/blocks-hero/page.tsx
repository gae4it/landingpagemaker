...
export default function BlocksHeroPage() {
  ...
  const centeredHeroReactSnippet = `<section className="relative overflow-hidden bg-linear-to-b from-neutral-50 to-neutral-100 py-24 sm:py-32 dark:from-neutral-950 dark:to-neutral-900">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
      ...
      <p className="mt-6 text-lg leading-8 text-neutral-600 dark:text-neutral-400">
        Create stunning websites with pre-built, fully customizable sections.
      </p>
  ...
  const heroWithImageReactSnippet = `<section className="relative bg-white py-16 sm:py-24 lg:py-32 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
      ...
      <div className="relative h-96 rounded-lg bg-linear-to-br from-neutral-200 to-neutral-300 dark:from-neutral-800 dark:to-neutral-700">
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-neutral-500 dark:text-neutral-400">Product image</span>
        </div>
      </div>
    </div>
  </div>
  ...
  const gradientHeroReactSnippet = `<section className="relative overflow-hidden bg-linear-to-r from-neutral-900 via-neutral-800 to-neutral-900 py-24 text-white sm:py-32 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
      <p className="text-sm font-semibold tracking-widest text-neutral-400 uppercase">
        Introducing features
      </p>
      <h1 className="mt-4 text-5xl font-bold sm:text-6xl">Powerful tools for everyone</h1>
  ...
  const heroWithFeaturesReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
  ...
  const splitLayoutHeroReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 items-stretch gap-12 lg:grid-cols-2 lg:gap-16">
      <div className="flex flex-col justify-center">
        ...
        <p className="mt-4 text-lg text-neutral-600 dark:text-neutral-400">
          Discover how thousands of companies are already using our platform to drive growth.
        </p>
        <ul className="mt-8 space-y-4">
          {["Seamless integration", "Real-time analytics", "Enterprise security"].map((item) => (
      ...
      <div className="relative rounded-lg bg-linear-to-br from-neutral-100 to-neutral-200 dark:from-neutral-900 dark:to-neutral-800">
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-neutral-500 dark:text-neutral-400">Feature image</span>
        </div>
      </div>
    </div>
  </div>
  ...
  const minimalHeroReactSnippet = `<section className="relative py-32 sm:py-48">
  <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
    <div className="space-y-6">
      ...
      <p className="max-w-2xl text-xl text-neutral-600 dark:text-neutral-400">
        Clean, minimal design with maximum impact. Perfect for showcasing your work.
      </p>
      <div className="pt-6">
  ...
  const mediaBackgroundHeroReactSnippet = `<section className="relative h-screen min-h-96 overflow-hidden">
  ...
  <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-2xl text-center text-white">
      <h1 className="text-5xl font-bold sm:text-6xl">Bold visual presence</h1>
      <p className="mt-6 text-xl text-neutral-100">
        Create impactful landing pages with stunning full-screen heroes.
      </p>
  ...
  const imageOverlayHeroReactSnippet = `<section className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  ...
  <div className="mx-auto max-w-2xl text-center">
    ...
    <p className="mt-6 text-lg leading-8 text-gray-300">
      Build beautiful landing pages with ready-to-use hero sections. Copy, paste, and customize.
    </p>
    <div className="mt-10 flex items-center justify-center gap-x-6">
      <a
        href="#"
        className="rounded-md bg-indigo-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400"
      >
        Get started
      </a>
          ...
          <div className="relative">
            <SectionDivider title="Centered Hero with CTA">
              <CopySnippetButtons
                ...
                reactSnippet={centeredHeroReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef1}
          ...
          <div className="relative">
            <SectionDivider title="Hero with Image">
              <CopySnippetButtons
                ...
                reactSnippet={heroWithImageReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef2}
          ...
          <div className="relative">
            <SectionDivider title="Gradient Hero">
              <CopySnippetButtons
                ...
                reactSnippet={gradientHeroReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef3}
          ...
          <div className="relative">
            <SectionDivider title="Hero with Features">
              <CopySnippetButtons
                ...
                reactSnippet={heroWithFeaturesReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef4}
          ...
          <div className="relative">
            <SectionDivider title="Split Layout Hero">
              <CopySnippetButtons
                ...
                reactSnippet={splitLayoutHeroReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef5}
          ...
          <div className="relative">
            <SectionDivider title="Minimal Hero">
              <CopySnippetButtons
                ...
                reactSnippet={minimalHeroReactSnippet}
              />
            </SectionDivider>
          ...
          <div className="relative">
            <SectionDivider title="Hero with Media Background">
              <CopySnippetButtons
                ...
                reactSnippet={mediaBackgroundHeroReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef7}
          ...
          <div className="relative">
            <SectionDivider title="Image Background Overlay Hero">
              <CopySnippetButtons
                ...
                reactSnippet={imageOverlayHeroReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef8}
