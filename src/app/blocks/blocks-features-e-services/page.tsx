...
export default function BlocksFeaturesEServicesPage() {
  ...
  const featuresGridReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
      {[
        { icon: Zap, title: "Lightning Fast", description: "Optimized for speed with instant loading times" },
        ...
        { icon: Rocket, title: "Easy Deployment", description: "Deploy in seconds with our one-click solution" },
      ].map((feature, idx) => (
        <div key={idx} className="text-center">
          ...
          <h3 className="mb-2 text-lg font-semibold text-neutral-950 dark:text-neutral-50">{feature.title}</h3>
  ...
  const featuresTabsReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-900">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="text-center">
      <h2 className="text-3xl font-bold text-neutral-950 sm:text-4xl dark:text-neutral-50">
    ...
    <div className="mt-12 flex flex-wrap justify-center gap-3">
      {["Development", "Design", "Marketing", "Analytics"].map((tab) => (
        <button
          key={tab}
    ...
    <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
      <div className="rounded-lg border border-neutral-200 bg-white p-8 dark:border-neutral-800 dark:bg-neutral-950">
        <h3 className="mb-4 text-xl font-semibold text-neutral-950 dark:text-neutral-50">Development Tools</h3>
        <ul className="space-y-3">
          {["Code editor integration", "Version control", "CI/CD pipeline", "Testing framework"].map((item) => (
      ...
      <div className="flex items-center justify-center rounded-lg border border-neutral-200 bg-neutral-100 p-8 dark:border-neutral-800 dark:bg-neutral-800">
        <p className="text-center text-neutral-600 dark:text-neutral-400">Feature preview area</p>
      </div>
    </div>
  </div>
</section>`;

  const featuresHoverReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {[
        ...
        >
          ...
          <h3 className="mb-2 text-xl font-semibold text-neutral-950 dark:text-neutral-50">{feature.title}</h3>
          <p className="text-neutral-600 dark:text-neutral-400">{feature.description}</p>
          <div className="mt-4 h-0 overflow-hidden opacity-0 transition-all group-hover:h-auto group-hover:opacity-100">
            <a href="#" className="inline-flex items-center text-sm font-medium text-neutral-900 hover:underline dark:text-neutral-50">
              Learn more →
            </a>
          </div>
        </div>
  ...
  const featuresTimelineReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-900">
  <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
    <div className="text-center">
      <h2 className="text-3xl font-bold text-neutral-950 sm:text-4xl dark:text-neutral-50">How it works</h2>
    </div>
    <div className="mt-16 space-y-12">
      {[
        { step: "1", title: "Sign up", desc: "Create your account in seconds" },
        { step: "2", title: "Connect", desc: "Integrate with your favorite tools" },
        { step: "3", title: "Launch", desc: "Go live and start growing" },
        { step: "4", title: "Scale", desc: "Expand as your business grows" },
      ].map((item, idx) => (
        <div key={idx} className="relative flex gap-6">
          <div className="flex flex-col items-center">
            ...
            {idx < 3 && <div className="mt-2 h-full w-0.5 bg-neutral-300 dark:bg-neutral-700" />}
          </div>
          <div className="flex-1 pb-8">
            <h3 className="mb-2 text-xl font-semibold text-neutral-950 dark:text-neutral-50">{item.title}</h3>
  ...
  const featuresComparisonReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <div className="overflow-x-auto">
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-neutral-200 dark:border-neutral-800">
            <th className="px-6 py-4 text-left text-sm font-semibold text-neutral-950 dark:text-neutral-50">Feature</th>
            <th className="px-6 py-4 text-center text-sm font-semibold text-neutral-950 dark:text-neutral-50">Basic</th>
            <th className="px-6 py-4 text-center text-sm font-semibold text-neutral-950 dark:text-neutral-50">Pro</th>
            <th className="px-6 py-4 text-center text-sm font-semibold text-neutral-950 dark:text-neutral-50">Enterprise</th>
          </tr>
        </thead>
        <tbody>
          {[
            ...
            <tr key={idx} className="border-b border-neutral-200 dark:border-neutral-800">
              <td className="px-6 py-4 text-sm text-neutral-700 dark:text-neutral-300">{row.name}</td>
              <td className="px-6 py-4 text-center text-sm text-neutral-600 dark:text-neutral-400">{row.basic}</td>
              <td className="px-6 py-4 text-center text-sm text-neutral-600 dark:text-neutral-400">{row.pro}</td>
              <td className="px-6 py-4 text-center text-sm text-neutral-600 dark:text-neutral-400">{row.enterprise}</td>
            </tr>
          ))}
        </tbody>
      </table>
  ...
  const featuresCarouselReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-900">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
      <div>
        ...
        <ul className="mt-8 space-y-4">
          {[
            ...
            { title: "Easy Deployment", description: "Deploy in seconds" },
          ].map((feature, idx) => (
            <li key={idx} className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-neutral-950 dark:text-neutral-50">{feature.title}</h4>
      ...
      <div className="rounded-lg border border-neutral-200 bg-neutral-100 p-4 dark:border-neutral-800 dark:bg-neutral-800">
        ...
        <div className="mt-4 flex justify-center gap-2">
          {[0, 1, 2].map((dot) => (
            <button key={dot} className="h-2 w-2 rounded-full bg-neutral-400 dark:bg-neutral-600" aria-label={\`Slide \${dot + 1}\`} />
          ))}
        </div>
      </div>
    </div>
  ...
  const featuresAnimatedIconsReactSnippet = `<section className="relative bg-white py-16 sm:py-24 dark:bg-neutral-950">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="text-center">
      <h2 className="text-3xl font-bold text-neutral-950 sm:text-4xl dark:text-neutral-50">Why choose us</h2>
    </div>
    <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
      {[
        { icon: TrendingUp, title: "Fast Growth", color: "text-blue-600" },
        { icon: Award, title: "Award Winning", color: "text-purple-600" },
        { icon: Clock, title: "24/7 Support", color: "text-green-600" },
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-neutral-950 dark:text-neutral-50">{item.title}</h3>
        </div>
      ))}
    </div>
  </div>
  ...
  const featuresStepsReactSnippet = `<section className="relative bg-neutral-50 py-16 sm:py-24 dark:bg-neutral-900">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="text-center">
      <h2 className="text-3xl font-bold text-neutral-950 sm:text-4xl dark:text-neutral-50">
    ...
    <div className="mt-16 grid grid-cols-1 gap-12 md:grid-cols-3">
      {[
        { num: "01", title: "Create Account", desc: "Sign up and set up your profile in minutes" },
        { num: "02", title: "Customize", desc: "Tailor the platform to your needs" },
        { num: "03", title: "Launch", desc: "Go live and start achieving your goals" },
      ].map((step, idx) => (
        <div key={idx} className="text-center">
          <div className="mb-4 text-6xl font-bold text-neutral-200 dark:text-neutral-800">{step.num}</div>
          <h3 className="mb-2 text-xl font-semibold text-neutral-950 dark:text-neutral-50">{step.title}</h3>
          ...
          <div className="relative">
            <SectionDivider title="Features Grid (Icons + Text)">
              <CopySnippetButtons
                ...
                reactSnippet={featuresGridReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef1}
          ...
          <div className="relative">
            <SectionDivider title="Features with Tabs">
              <CopySnippetButtons
                ...
                reactSnippet={featuresTabsReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef2}
          ...
          <div className="relative">
            <SectionDivider title="Features with Hover Reveal">
              <CopySnippetButtons
                ...
                reactSnippet={featuresHoverReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef3}
          ...
          <div className="relative">
            <SectionDivider title="Features Timeline">
              <CopySnippetButtons
                ...
                reactSnippet={featuresTimelineReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef4}
          ...
          <div className="relative">
            <SectionDivider title="Features Comparison Table">
              <CopySnippetButtons
                ...
                reactSnippet={featuresComparisonReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef5}
          ...
          <div className="relative">
            <SectionDivider title="Features with Image Carousel">
              <CopySnippetButtons
                ...
                reactSnippet={featuresCarouselReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef6}
          ...
          <div className="relative">
            <SectionDivider title="Features with Animated Icons">
              <CopySnippetButtons
                ...
                reactSnippet={featuresAnimatedIconsReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef7}
          ...
          <div className="relative">
            <SectionDivider title="Feature Steps (Numbered Workflow)">
              <CopySnippetButtons
                ...
                reactSnippet={featuresStepsReactSnippet}
              />
            </SectionDivider>
            <section
              ref={sectionRef8}
